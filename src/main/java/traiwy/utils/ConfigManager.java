...
public class ConfigManager {
    ...
    @Getter
    private Map<String, Gui.Quest> questsList = new LinkedHashMap<>();
    ...
    public void parseGui() {
        ...
        Gui.Quests.slots = questSection.getIntegerList("slots");
        ...
        for (String questKey : questSection.getKeys(false)) {
            ...
            if(questInfoSection == null) log.info("Section " + questInfoSection + " is null");
            ...
            if (questInfoSection != null) {
                ...
                log.info("Section:  " + questKey + " wasn't founded");
            }
        }
    }
